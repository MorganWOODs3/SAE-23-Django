...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Absences',
            fields=[
                ('idabsences', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idgroupes_etudiant', models.AutoField(db_column='idGroupes-etudiant', primary_key=True, serialize=False)),
                ('nom', models.CharField(blank=True, db_column='Nom', max_length=45, null=True)),
            ],
            options={
